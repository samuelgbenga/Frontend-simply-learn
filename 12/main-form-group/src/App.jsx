...
// creat and array of object label and value
...
const App = () => {
  ...
  // destructure field in field to
  // have property contryfield
      ...
      <FormGroup errorMessage={errors?.email?.message}>
        ...
        <input
          ...
          {...register("email", {
            ...
            validate: (value) => {
              if (!value.endsWith("@samuel.com")) {
                return "Must end with @samuel.com";
              }
            },
          })}
        />
